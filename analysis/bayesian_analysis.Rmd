...
The effect of task on noise was notable (greater noise in the ME task). The only other credible effect was that of trial:laterality. No such interaction effect was set, however. Therefore, this effect, however small, is spurious. 
...
The three-way interaction is very apparent (i.e. ME makes the increase of LI with trial greater than does MI). The two-interaction between trial and laterality is also rather clear since the effect of trial on laterality is so pronounce in the ME condition (i.e. it is generating the two-way interaction, despite an opposing interaction in the MI condition). All three main effects are also clear to see in timeseries plot below.
...
The 95% CIs of the parameter estimates capture all the true population coefficients.
...
Just overestimates trial coefficient variability and underestimates laterality coefficient variability. OTherwise, the 95% CIs appear to capture all the coefficient SDs (1-8). We will ignore the noise SDs for now. 
