...
trial_laterality_interaction_mean = 0.5/240
...
## 3-way interaction
# ME makes the increase of LI with trial greater than MI
trial_task_laterality_interaction_mean = 1/240
...
dat$log_relative_power = rnorm(nrow(dat), dat$obs, noise)

names(dat)[3:5] = c("task", "trial", "laterality")
dat$task = factor(dat$task, labels = c("ME", "MI"))
dat$trial = dat$trial 
dat$laterality = factor(dat$laterality, labels = c("contra", "ipsi"))
